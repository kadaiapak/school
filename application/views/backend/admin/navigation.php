<div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        <a href="#" class="waves-effect"><img src="<?= base_url(); ?>assets/plugins/images/users/d1.jpg" alt="user-img" class="img-circle"> <span class="hide-menu">Dr. Steve Gection<span class="fa arrow"></span></span>
                        </a>
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="linea-icon linea-basic fa-fw text-danger" data-icon="7"></i> <span class="hide-menu text-danger"> Multipurpose <span class="fa arrow"></span> <span class="label label-rouded label-danger pull-right">HOT</span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-hospital/index.html">Hospital Admin</a> </li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-crm/index.html">CRM Admin</a> </li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-university/index.html">University Admin</a> </li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-music/index.html">Music Admin</a> </li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-real-estate/index.html">Real Estate Admin</a> </li>
                            <li role="separator" class="divider"></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-inverse/index.html">Inverse</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-colors/index.html">Colors</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin/index.html">Eliteadmin</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-wpmenu/index.html">Wpmenu</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-ecommerce/index.html">Ecommerce</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-modern/index.html">Modern</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-inverse-php/index.php">Basic PHP</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-material/index3.html">Material Design</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-dark/index.html">Dark</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-mini-sidebar/index3.html">Mini Sidebar</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-horizontal-navbar/index3.html">Horizontal Boxed Nav</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-horizontal-nav-fullwidth/index.html">Horizontal Full Nav</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-iconbar/index4.html">Iconbar</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-rtl/index.html">Eliteadmin RTL</a></li>
                            <li> <a href="<?= base_url(); ?>assets/eliteadmin-inverse-rtl/index.html">Inverse RTL</a></li>
                        </ul>
                    </li>
            ...
            <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a href="<?= base_url(); ?>assets/email-templates/basic.html">Basic</a></li>
                                    <li><a href="<?= base_url(); ?>assets/email-templates/alert.html">Alert</a></li>
                                    <li><a href="<?= base_url(); ?>assets/email-templates/billing.html">Billing</a></li>
                                    <li><a href="<?= base_url(); ?>assets/email-templates/password-reset.html">Reset Pwd</a></li>
                                </ul>
                            </li>
