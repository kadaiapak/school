  ...
  <div class="login-box login-sidebar">
    <div class="white-box">
      <form class="form-horizontal form-material" id="loginform" action="index.html">
        <a href="javascript:void(0)" class="text-center db"><img src="<?= base_url(); ?>assets/plugins/images/eliteadmin-logo-dark.png" alt="Home" /><br/><img src="<?= base_url(); ?>assets/plugins/images/eliteadmin-text-dark.png" alt="Home" /></a>  
        ...
        <div class="form-group">
          <div class="col-md-12">
            <div class="checkbox checkbox-primary pull-left p-t-0">
              ...
              <label for="checkbox-signup"><?= get_phrase('Remember me') ?></label>
            </div>
